...
class anime(commands.Cog):
    ...
    @commands.command()
    async def waifu(self, ctx, types:str = "sfw"):

        types = "nsfw" if not types else types
        reponse = requests.get(f"https://api.waifu.pics/{types}/waifu").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def neko(self, ctx, types:str = "sfw"):
        types = "nsfw" if not types else types
        reponse = requests.get(f"https://api.waifu.pics/{types}/neko").json()
        await ctx.send(reponse["url"])

    
    @commands.command()
    async def shinobu(self, ctx, types:str = "sfw"):
        types = "nsfw" if not types else types
        reponse = requests.get(f"https://api.waifu.pics/{types}/shinobu").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def megumin(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/megumin").json()
        await ctx.send(reponse["url"])
    
    @commands.command() 
    async def attack(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/bully").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def cuddle(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/cuddle").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def cry(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/cry").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def hug(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/hug").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def awoo(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/awoo").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def kiss(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/kiss").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def lick(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/lick").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def pat(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/pat").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def smug(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/smug").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def bonk(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/bonk").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def yeet(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/yeet").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def blush(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/blush").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def smile(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/smile").json()
        await ctx.send(reponse["url"])


    @commands.command()
    async def wave(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/wave").json()
        await ctx.send(reponse["url"])


    @commands.command()
    async def highfive(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/highfive").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def handhold(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/handhold").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def nom(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/nom").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def bite(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/bite").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def glomp(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/glomp").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def slap(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/slap").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def kill(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/kill").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def happy(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/happy").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def wink(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/wink").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def poke(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/poke").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def dance(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/dance").json()
        await ctx.send(reponse["url"])

    @commands.command()
    async def cringe(self, ctx):
        reponse = requests.get("https://api.waifu.pics/sfw/cringe").json()
        await ctx.send(reponse["url"])
